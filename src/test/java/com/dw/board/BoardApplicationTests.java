...
class BoardApplicationTests {
	...
	void contextLoads() {
		...
		int pageNum = 2; // 현재 페이지 번호
		int pageSize = 10;// 한 페이지에 게시물 10개
		int navigatePages = 5; // 한블록의 페이지 5개
		...
		List<Map<String, Object>> list = boardMapper.selectSearchBoardListTEST(limitStart, pageSize);

		for (Map<String, Object> param : list) {
			String studentsName = (String) param.get("students_name");
